...
const Attributes = () => {
    ...
    const additionalField = [
        ...
        {
            title: "عملیات",
            elements: (rowData)=> <AttrAction rowData={rowData} attrToEdit={attrToEdit} setAttrToEdit={setAttrToEdit} handleDeleteCategoryAttr={handleDeleteCategoryAttr}/>
        }
    ]
    ...
    const handleDeleteCategoryAttr = async (attr)=>{
        if( await Confirm(`حدف ${attr.title}` , "آیا از حذف این رکورد اطمینان دارید؟")){
            try {
